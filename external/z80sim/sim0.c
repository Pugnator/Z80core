...
#ifdef Z80_UNDOC
#ifdef HAS_DISKS
				printf("usage:\t%s -z -8 -s -l -i -u -mn -fn -xfilename -ddiskpath\n", pn);
#else
				printf("usage:\t%s -z -8 -s -l -i -u -mn -fn -xfilename\n", pn);
#endif
#else
#ifdef HAS_DISKS
				printf("usage:\t%s -z -8 -s -l -i -mn -fn -xfilename -ddiskpath\n", pn);
#else
				printf("usage:\t%s -z -8 -s -l -i -mn -fn -xfilename\n", pn);
#endif
#endif
