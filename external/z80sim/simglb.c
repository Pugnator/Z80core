 ...
 */
BYTE prot1[1024];		/* fence */
BYTE ram[65536];		/* 64KB RAM */
BYTE prot2[1024];		/* fence */
...
#endif
char xfn[255];			/* buffer for filename (option -x) */
char *diskdir = NULL;		/* path for disk images, default if not set */
char diskd[4096];		/* otherwise this path */
