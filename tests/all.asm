...
;Fix 14.03.2018 fixed IX + n opcodes to contain only signed data
...
BIT 0, [IX + 0x7F]       		;0xddcb7f40       		#size:4
BIT 0, [IX + 0x7F]       		;0xddcb7f41       		#size:4
BIT 0, [IX + 0x7F]       		;0xddcb7f42       		#size:4
...
BIT 0, [IX + 0x7F]       		;0xfdcb7f42       		#size:4
BIT 0, [IX + 0x7F]       		;0xfdcb7f43       		#size:4
BIT 0, [IX + 0x7F]       		;0xfdcb7f44       		#size:4
...
BIT 1, [IX + 0x7F]       		;0xddcb7f49       		#size:4
BIT 1, [IX + 0x7F]       		;0xddcb7f4a       		#size:4
...
BIT 1, [IX + 0x7F]       		;0xfdcb7f4a       		#size:4
BIT 1, [IX + 0x7F]       		;0xfdcb7f4b       		#size:4
BIT 1, [IX + 0x7F]       		;0xfdcb7f4c       		#size:4
...
BIT 2, [IX + 0x7F]       		;0xddcb7f50       		#size:4
BIT 2, [IX + 0x7F]       		;0xddcb7f51       		#size:4
BIT 2, [IX + 0x7F]       		;0xddcb7f52       		#size:4
...
BIT 2, [IX + 0x7F]       		;0xfdcb7f52       		#size:4
BIT 2, [IX + 0x7F]       		;0xfdcb7f53       		#size:4
BIT 2, [IX + 0x7F]       		;0xfdcb7f54       		#size:4
...
BIT 3, [IX + 0x7F]       		;0xddcb7f58       		#size:4
BIT 3, [IX + 0x7F]       		;0xddcb7f59       		#size:4
BIT 3, [IX + 0x7F]       		;0xddcb7f5a       		#size:4
...
BIT 3, [IX + 0x7F]       		;0xfdcb7f5a       		#size:4
BIT 3, [IX + 0x7F]       		;0xfdcb7f5b       		#size:4
BIT 3, [IX + 0x7F]       		;0xfdcb7f5c       		#size:4
...
BIT 4, [IX + 0x7F]       		;0xddcb7f60       		#size:4
BIT 4, [IX + 0x7F]       		;0xddcb7f61       		#size:4
BIT 4, [IX + 0x7F]       		;0xddcb7f62       		#size:4
...
BIT 4, [IX + 0x7F]       		;0xfdcb7f62       		#size:4
BIT 4, [IX + 0x7F]       		;0xfdcb7f63       		#size:4
BIT 4, [IX + 0x7F]       		;0xfdcb7f64       		#size:4
...
BIT 5, [IX + 0x7F]       		;0xddcb7f68       		#size:4
BIT 5, [IX + 0x7F]       		;0xddcb7f69       		#size:4
BIT 5, [IX + 0x7F]       		;0xddcb7f6a       		#size:4
...
BIT 5, [IX + 0x7F]       		;0xfdcb7f6a       		#size:4
BIT 5, [IX + 0x7F]       		;0xfdcb7f6b       		#size:4
BIT 5, [IX + 0x7F]       		;0xfdcb7f6c       		#size:4
...
BIT 6, [IX + 0x7F]       		;0xddcb7f71       		#size:4
BIT 6, [IX + 0x7F]       		;0xddcb7f72       		#size:4
...
BIT 6, [IX + 0x7F]       		;0xfdcb7f72       		#size:4
BIT 6, [IX + 0x7F]       		;0xfdcb7f73       		#size:4
BIT 6, [IX + 0x7F]       		;0xfdcb7f74       		#size:4
...
BIT 7, [IX + 0x7F]       		;0xddcb7f78       		#size:4
BIT 7, [IX + 0x7F]       		;0xddcb7f79       		#size:4
BIT 7, [IX + 0x7F]       		;0xddcb7f7a       		#size:4
...
BIT 7, [IX + 0x7F]       		;0xfdcb7f7a       		#size:4
BIT 7, [IX + 0x7F]       		;0xfdcb7f7b       		#size:4
BIT 7, [IX + 0x7F]       		;0xfdcb7f7c       		#size:4
...
LD [IX + 0x7F], D       		;0xfd727f       		#size:3
LD [IX + 0x7F], E       		;0xfd737f       		#size:3
LD [IX + 0x7F], H       		;0xfd747f       		#size:3
